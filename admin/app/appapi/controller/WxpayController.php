...
<attach><![CDATA[充值星币,价值为600]]></attach>
...
<transaction_id><![CDATA[4200000432201912210816702746]]></transaction_id>
	...
	public function logwx($msg){
		file_put_contents(CMF_ROOT.'log/think/appapi/wxpay/logwx_'.date('Y-m-d').'.txt',date('Y-m-d H:i:s').'  msg:'.$msg."\r\n",FILE_APPEND);
	}	
    
    /* 公众号 */
	public function logwx2($msg){
		file_put_contents(CMF_ROOT.'log/think/appapi/wxpay/logwx2_'.date('Y-m-d').'.txt',date('Y-m-d H:i:s').'  msg:'.$msg."\r\n",FILE_APPEND);
	}		
