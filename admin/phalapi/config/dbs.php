...
return array(
    ...
    'servers' => array(
        'db_master' => array(                       // 服务器标记 / database identify
            ...
            'host'      => getenv('DATABASE_HOSTNAME') ?: 'localhost',             // 数据库域名 / database host
            'name'      => getenv('DATABASE_DATABASE') ?: '',               // 数据库名字 / database name
            'user'      => getenv('DATABASE_USERNAME') ?: '',                  // 数据库用户名 / database user
            'password'  => getenv('DATABASE_PASSWORD') ?: '',                      // 数据库密码 / database password
            'port'      => getenv('DATABASE_HOSTPORT') ?: '3306',                  // 数据库端口 / database port
