(function(){
    ...
    function resizeCharts(){
        echarts_basic.resize();
        echarts_source.resize();
        echarts_reg.resize();
        echarts_charge.resize();
    }

    $(window).off('resize.adminHome').on('resize.adminHome', resizeCharts);
    $(document).off('adminWorkspace:loaded.adminHome').on('adminWorkspace:loaded.adminHome', function(){
