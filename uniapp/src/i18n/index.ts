...
export const supportedLocales = ["zh-CN", "en", "ja", "ko", "vi"] as const;
...
const baseMessages = {
  "zh-CN": {
    language: { title: "语言", system: "跟随系统", changed: "语言已切换", zh: "简体中文", en: "English", ja: "日本語", ko: "한국어", vi: "Tiếng Việt" },
  ...
  en: {
    language: { title: "Language", system: "Follow system", changed: "Language changed", zh: "简体中文", en: "English", ja: "日本語", ko: "한국어", vi: "Tiếng Việt" },
  ...
  ja: {
    language: { title: "言語", system: "システム設定に従う", changed: "言語を変更しました", zh: "简体中文", en: "English", ja: "日本語", ko: "한국어", vi: "Tiếng Việt" },
  ...
  ko: {
    language: { title: "언어", system: "시스템 설정 따르기", changed: "언어가 변경되었습니다", zh: "简体中文", en: "English", ja: "日本語", ko: "한국어", vi: "Tiếng Việt" },
  ...
  vi: {
    language: { title: "Ngôn ngữ", system: "Theo hệ thống", changed: "Đã thay đổi ngôn ngữ", zh: "简体中文", en: "English", ja: "日本語", ko: "한국어", vi: "Tiếng Việt" },
    tab: { home: "Trang chủ", game: "Trò chơi", sports: "Thể thao", dynamic: "Bảng tin", me: "Tôi" },
    settings: { title: "Cài đặt", profile: "Hồ sơ của tôi", password: "Đổi mật khẩu", remote: "Hỗ trợ từ xa", cancel: "Xóa tài khoản", invalid: "Trang phiên đăng nhập hết hạn", sessionRevalidate: "Phiên đăng nhập của bạn cần được xác minh lại", logout: "Đăng xuất", logoutConfirm: "Đăng xuất khỏi tài khoản này?", loggedOut: "Đã đăng xuất" },
    me: { welcome: "Chào mừng đến với Starfield", loginHint: "Đăng nhập để xem tài sản và tin nhắn", login: "Đăng nhập", noAccount: "Chưa có tài khoản?", register: "Tạo tài khoản", fans: "Người hâm mộ", following: "Đang theo dõi", favorites: "Yêu thích", recharge: "Nạp tiền", rechargeReward: "Thưởng nạp", coin: "Xu", details: "Chi tiết", viewDetails: "Xem chi tiết", verify: "Xác minh", goVerify: "Xác minh ngay", myServices: "Dịch vụ của tôi", moreServices: "Thêm dịch vụ", video: "Video", income: "Thu nhập", dailyTask: "Nhiệm vụ hằng ngày", roomManage: "Quản lý phòng", inviteReward: "Phần thưởng giới thiệu", winningRecord: "Lịch sử trúng thưởng", support: "Hỗ trợ", defaultUser: "Người dùng Starfield", loadFailed: "Không thể tải hồ sơ" }
  }
} as const;
...
const messageBundles: Array<Record<string, MessageTree>> = [
  ...
  viMessages as unknown as Record<string, MessageTree>
];
